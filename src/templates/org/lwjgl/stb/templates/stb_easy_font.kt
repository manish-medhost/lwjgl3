...
import org.lwjgl.stb.stbi_io_callbacks_p
import org.lwjgl.stb.stbi_uc_p
...
void print_string(float x, float y, char *text, float r, float g, float b)
{
	...
	int(
		...
		charASCII_p.OUT("text", "an ASCII string"),
...
color:uint8[4]""")}
		...
		float.IN("y", ""),
		charASCII_p.OUT("text", "an ASCII string"),
		Check(4) _ unsigned_char_p.OUT("color", "the text color, in RGBA (4 bytes)"),
